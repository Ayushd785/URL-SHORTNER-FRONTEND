    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="p-4 bg-gray-50 rounded-lg space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-mono text-blue-600">sh.ly/{linkInfo.shortCode}</span>
              </div>
              {linkInfo.description && (
                <div className="flex items-start justify-between text-sm">
                  <span className="text-gray-500">Description:</span>
                  <span className="text-gray-700 text-right max-w-48">{linkInfo.description}</span>
                </div>
              )}
              <div className="flex items-center justify-between text-sm">
            ...
            {isBlocked && (
              <Alert className="border-red-200 bg-red-50">
                ...
                <AlertDescription className="text-red-800">
                  Too many failed attempts. This link has been temporarily blocked for security.
                </AlertDescription>
              </Alert>
            )}
              ...
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-blue-700">
                    Use password <code className="bg-blue-100 px-1 rounded">demo123</code> or{' '}
                    <code className="bg-blue-100 px-1 rounded">password</code> to test this feature.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <p className="text-xs text-gray-500">
                This link is protected for your security. Only users with the correct password can access the content.
              </p>
            </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            🔒 Your security is our priority. All password verification is encrypted and secure.
          </p>
        </div>
      </div>
    </div>
