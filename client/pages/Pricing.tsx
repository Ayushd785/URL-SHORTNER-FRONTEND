...
export default function Pricing() {
  ...
  const getSavings = (plan: PricingPlan) => {
    ...
    if (billingCycle === "quarterly" && monthly > 0) {
      ...
      const savings = Math.round(((monthlyCost - quarterly) / monthlyCost) * 100);
      return savings > 0 ? `Save ${savings}%` : null;
    }
    
    if (billingCycle === "annually" && monthly > 0) {
      const monthlyCost = monthly * 12;
      const savings = Math.round(((monthlyCost - annually) / monthlyCost) * 100);
      return savings > 0 ? `Save ${savings}%` : null;
    }
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Button variant="ghost" className="text-blue-600">Pricing</Button>
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center space-x-4 mb-8">
            ...
            <Button
              ...
              className={billingCycle === "quarterly" ? "bg-blue-100 text-blue-700" : ""}
            >
              Quarterly
            </Button>
              ...
              <CardHeader className={plan.popular ? "pt-12" : "pt-6"}>
                <div className="flex items-center space-x-3 mb-4">
                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                    ...
                    plan.name === "Business" ? "bg-purple-100 text-purple-600" :
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{plan.limits.customDomains}</span>
                    </div>
                    <div className="flex justify-between">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  <th className="text-left px-6 py-4 font-semibold text-gray-900">Features</th>
                  <th className="text-center px-6 py-4 font-semibold text-gray-900">Free</th>
                  <th className="text-center px-6 py-4 font-semibold text-gray-900">Pro</th>
                  <th className="text-center px-6 py-4 font-semibold text-gray-900">Business</th>
                  <th className="text-center px-6 py-4 font-semibold text-gray-900">Enterprise</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {[
                  { name: "URL Shortening", free: true, pro: true, business: true, enterprise: true },
                  { name: "QR Code Generation", free: true, pro: true, business: true, enterprise: true },
                  ...
                  { name: "Custom Aliases", free: false, pro: true, business: true, enterprise: true },
                  { name: "Advanced Analytics", free: false, pro: true, business: true, enterprise: true },
                  { name: "Team Collaboration", free: false, pro: false, business: true, enterprise: true },
                  { name: "API Access", free: false, pro: false, business: true, enterprise: true },
                  { name: "Custom Domains", free: false, pro: "3", business: "10", enterprise: "Unlimited" },
                  { name: "White-label", free: false, pro: false, business: true, enterprise: true },
                  { name: "SSO Integration", free: false, pro: false, business: true, enterprise: true },
                  { name: "24/7 Phone Support", free: false, pro: false, business: false, enterprise: true },
                ].map((feature, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center">
                      {typeof feature.business === 'boolean' ? (
                        feature.business ? <Check className="w-5 h-5 text-green-500 mx-auto" /> : <X className="w-5 h-5 text-gray-300 mx-auto" />
                      ) : (
            ...
            {[
              {
                ...
                answer: "We'll notify you when you approach your limits. You can upgrade anytime to continue service without interruption."
              },
              {
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-white">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of users who trust LinklyPro for their URL shortening needs.
            </p>
