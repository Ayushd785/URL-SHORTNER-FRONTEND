...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="container mx-auto px-4 py-3 md:py-4 flex items-center justify-between">
          ...
          >
            <div className="w-7 h-7 md:w-8 md:h-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex items-center justify-center">
              <Link className="w-4 h-4 md:w-5 md:h-5 text-white" />
            </div>
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <Button onClick={() => navigate("/signup")} className="min-h-[44px]">Get Started</Button>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t bg-white/95 backdrop-blur-sm animate-in slide-in-from-top-2 duration-200">
            <div className="container mx-auto px-4 py-4 space-y-4">
              <a
                href="#features"
                className="block text-gray-600 hover:text-gray-900 transition-colors py-3 min-h-[44px] flex items-center"
              ...
              <button
                ...
                className="block text-gray-600 hover:text-gray-900 transition-colors py-3 text-left w-full min-h-[44px] flex items-center"
              >
                Pricing
              </button>
              <a
      ...
      <section
        id="hero"
        className="container mx-auto px-4 py-8 md:py-12 lg:py-20 text-center"
      >
        <div className="max-w-4xl mx-auto">
          <Badge variant="secondary" className="mb-3 md:mb-4 animate-slide-up-delay-1 text-xs md:text-sm">
            Not your regular Url Shortner
          </Badge>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-4 md:mb-6 leading-tight animate-slide-up-delay-2 px-2">
            Shorten URLs &
          ...
          <p className="text-base md:text-lg lg:text-xl text-gray-600 mb-6 md:mb-8 max-w-2xl mx-auto animate-slide-up-delay-3 px-4 leading-relaxed">
          ...
          <Card className="max-w-2xl mx-auto mb-8 md:mb-12 shadow-xl border-0 bg-white/80 backdrop-blur-sm mx-4 md:mx-auto">
            <CardContent className="p-4 md:p-6">
              ...
              <div className="flex justify-center mb-3 md:mb-4">
                <div className="flex bg-gray-100 rounded-lg p-1">
                  <button
                    ...
                    className={`flex items-center space-x-1 md:space-x-2 px-3 md:px-4 py-2 rounded-md transition-all min-h-[44px] ${
                      outputType === "url"
                  ...
                  >
                    ...
                    <span className="text-xs md:text-sm font-medium">Short URL</span>
                  </button>
                  <button
              ...
              <div className="flex flex-col gap-3">
                <Input
                  ...
                  className="flex-1 h-12 text-base border-gray-200 focus:border-blue-500"
                />
                <Button
                  onClick={handleShorten}
                  className="h-12 px-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-sm md:text-base min-h-[44px]"
                  disabled={!url}
                >
              ...
              {shortUrl && (
                <div className="mt-3 md:mt-4 p-3 md:p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex flex-col gap-2">
                    <span className="text-blue-800 font-medium text-sm break-all">
                      {shortUrl}
                    </span>
                    <Button
                      size="sm"
              ...
              {qrCode && (
                <div className="mt-3 md:mt-4 p-3 md:p-4 bg-purple-50 border border-purple-200 rounded-lg">
                  <div className="flex flex-col items-center space-y-3">
                    ...
                    />
                    <p className="text-xs text-purple-600 text-center mb-2 px-2">
                    ...
                    <div className="flex flex-col gap-2 w-full">
                      <Button
                        ...
                        className="flex items-center justify-center space-x-2 w-full min-h-[44px]"
                      >
      ...
      <section id="features" className="py-12 md:py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
            <Card className="p-4 md:p-6 hover:shadow-lg transition-shadow scroll-reveal stagger-1">
            ...
            <Card className="p-4 md:p-6 hover:shadow-lg transition-shadow scroll-reveal stagger-2">
              <CardContent className="p-0">
            ...
            <Card className="p-4 md:p-6 hover:shadow-lg transition-shadow scroll-reveal stagger-3">
              <CardContent className="p-0">
            ...
            <Card className="p-4 md:p-6 hover:shadow-lg transition-shadow scroll-reveal stagger-4">
              <CardContent className="p-0">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-teal-100 rounded-lg flex items-center justify-center mb-3 md:mb-4">
                  <Zap className="w-5 h-5 md:w-6 md:h-6 text-teal-600" />
                </div>
                <h3 className="text-lg md:text-xl font-semibold mb-2">Custom Domains</h3>
                <p className="text-sm md:text-base text-gray-600">
            ...
            <Card className="p-4 md:p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <h3 className="text-lg md:text-xl font-semibold mb-2">Global CDN</h3>
                <p className="text-sm md:text-base text-gray-600">
            ...
            <Card className="p-4 md:p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-red-100 rounded-lg flex items-center justify-center mb-3 md:mb-4">
                  <Link className="w-5 h-5 md:w-6 md:h-6 text-red-600" />
                </div>
                <h3 className="text-lg md:text-xl font-semibold mb-2">Bulk Management</h3>
                <p className="text-sm md:text-base text-gray-600">
            ...
            <Card className="p-4 md:p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <h3 className="text-lg md:text-xl font-semibold mb-2">API Access</h3>
                <p className="text-sm md:text-base text-gray-600">
      ...
      >
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-8 md:mb-12 lg:mb-16 scroll-reveal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12 lg:mb-16">
            <div className="text-center p-6 md:p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow scroll-reveal stagger-1">
              ...
              <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Our Mission</h3>
              <p className="text-sm md:text-base text-gray-600">
            ...
            <div className="text-center p-6 md:p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow scroll-reveal stagger-2">
              <div className="w-12 h-12 md:w-16 md:h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
            ...
            <div className="text-center p-6 md:p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow scroll-reveal stagger-3">
              ...
              <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Community</h3>
              <p className="text-sm md:text-base text-gray-600">
          ...
          {/* Stats Section */}
          <div id="stats" className="bg-white rounded-2xl shadow-xl p-6 md:p-8 lg:p-12 scroll-reveal">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 lg:gap-8 text-center">
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-1 md:mb-2">
                  {activeUsers}M+
                </div>
      ...
      <section id="developer" className="py-12 md:py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl p-6 md:p-8 lg:p-12 scroll-reveal">
              <div className="text-center">
                ...
                <div className="max-w-3xl mx-auto">
                  ...
                  <div className="text-sm md:text-base lg:text-lg text-gray-600 mb-4 md:mb-6 leading-relaxed">
                  ...
                  <div className="flex justify-center mb-4 md:mb-6">
                    <Button
                      className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white shadow-lg hover:shadow-xl transform hover:scale-105 hover:-translate-y-1 transition-all duration-300 ease-out flex items-center space-x-2 min-h-[44px]"
                      onClick={() =>
                        window.open(
                  ...
                  {/* Tech Stack */}
                  <div>
                    <h4 className="text-xs md:text-sm font-semibold text-gray-500 uppercase tracking-wide mb-2 md:mb-3">
              ...
              {/* Quote Section */}
              <div className="mt-6 md:mt-8 lg:mt-12 p-4 md:p-6 bg-white/80 rounded-2xl border border-white/20 backdrop-blur-sm">
                <div className="flex items-start space-x-4">
                  <Heart className="w-5 h-5 md:w-6 md:h-6 text-red-500 flex-shrink-0 mt-1" />
                  <div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col gap-3 md:gap-4 justify-center max-w-md mx-auto">
            ...
            <Button
              ...
              className="text-base md:text-lg px-6 md:px-8 py-3 text-white border-2 border-white bg-white/10 backdrop-blur-sm hover:bg-white hover:text-blue-600 transition-all duration-300 min-h-[44px]"
            >
              View Dashboard
            </Button>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-8 md:py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
            <div>
              <div
                className="flex items-center space-x-2 mb-3 md:mb-4 cursor-pointer hover:opacity-80 transition-opacity"
                onClick={() => navigate("/")}
              >
                <div className="w-7 h-7 md:w-8 md:h-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex items-center justify-center">
                  <Link className="w-4 h-4 md:w-5 md:h-5 text-white" />
                </div>
                <span className="text-lg md:text-xl font-bold">LinklyPro</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm md:text-base">
                <li>
                  <a href="#" className="hover:text-white transition-colors block py-1 min-h-[44px] flex items-center">
                    Features
                  </a>
                </li>
                <li>
          ...
          <div className="border-t border-gray-800 mt-6 md:mt-8 pt-6 md:pt-8 text-center text-gray-400">
            <p className="text-sm md:text-base">&copy; 2024 LinklyPro. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
